...
public class XMPPToolWindow implements RosterListener, ChatManagerListener, ConnectionListener, ChatMessageListener {
    ...
    private JBList<XMPPContact> listact;
    ...
    private Map<String, ChatWindow> chatMap = new HashMap<>();

    public static XMPPToolWindow getInstance() {
        return INSTANCE;
    }
    ...
    private XMPPToolWindow(Project project, ToolWindow toolWindow) {
        ...
        listact = new JBList<>((Collection<XMPPContact>) XMPPUsersListModel.getModel(XMPP.STATE.ACTIVE));
        ...
        listact.setTransferHandler(new TransferHandler() {
            ...
            public boolean importData(TransferSupport support) {
                ...
                try {
                    XMPPContact contact = listact.getSelectedValue();
                    if (contact != null) {
                        String user = contact.getUser();
                        System.out.println("testing");
                        if (support.isDataFlavorSupported(DataFlavor.javaFileListFlavor)) {
                            System.out.println("files");
                            java.util.List<File> data = (java.util.List<File>) support.getTransferable().getTransferData(DataFlavor.javaFileListFlavor);
                            for (File file : data) {
                ...
                } catch (UnsupportedFlavorException | IOException | SmackException e) {
                    e.printStackTrace();
                }
        ...
        JBList<XMPPContact> listina = new JBList<>((Collection<? extends XMPPContact>) XMPPUsersListModel.getModel(XMPP.STATE.INACTIVE));
    ...
    public void chatCreated(Chat chat, boolean createdLocally) {
        ...
        chatMap.put(chat.getParticipant(), chatWindow);
    ...
    private Chat openChat() {
        ...
        throw new IllegalArgumentException("no chat for user " + contact.getUser());
    }
    ...
    private ChatWindow getChatWindow(String user) {
        ...
        throw new IllegalArgumentException("no chat window for user " + user);
    }
    ...
    private ActionToolbar createToolbar() {
        ...
        return ActionManager.getInstance().createActionToolbar("unknown", group, true);
    }
    ...
    public void processMessage(Chat chat, Message message) {
        ChatWindow chatWindow = this.chatMap.get(chat.getParticipant());
        if (chatWindow == null) {
